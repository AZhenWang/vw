...
fields_map = {
    ...
    'new_share': [
        'code_id', 'sub_code', 'name', 'ipo_date', 'issue_date', 'amount',
    ...
    'fina_sys': [
        ...
        'roe',  'roe_sale', 'roe_mv', 'roe_mv_ci0', 'roe_mv_ci0' 'roe_std', 'roe_adj', 'roe_sale_mv', 'roe_ebitda', 'roe_ebitda_mv', 'op_pct',  'mix_op_diff',
        'V', 'V_ci0', 'V_ci1', 'V_adj', 'V_sale', 'V_ebitda', 'V_tax', 'dpd_V', 'chance_times', 'pp', 'pp_ci0', 'pp_ci1',  'pp_adj', 'pp_sale', 'pp_ebitda', 'pp_tax', 'dpd_RR',
        'pe', 'pb', 'EE', 'cashcover_ratio', 'i_debt', 'share_ratio', 'IER', 'oth_receiv_rate', 'money_cap_pct', 'st_borr_pct', 'st_borr_rate',
        'capital_turn', 'total_turn', 'inventory_turn', 'oper_pressure', 'OPM',
        'X1', 'X2', 'X3', 'X4', 'X5', 'Z',
        'dyr', 'dyr_or', 'dyr_mean',
        ...
        'LLP', 'LP', 'MP', 'HP', 'HHP', 'MP_pct',  'win_return', 'lose_return', 'odds', 'win_return2', 'lose_return2', 'odds2', 'adj_factor',
    ],
    'fina_super': [
