...
fields_map = {
    ...
    'balancesheet': [
        'code_id', 'date_id', 'f_ann_date', 'end_date', 'report_type', 'comp_type',
        'total_share',  'cap_rese', 'undistr', 'surplus_rese', 'special_rese', 'money_cap', 'trad_asset',
        'notes_receiv', 'accounts_receiv', 'oth_receiv', 'prepayment', 'div_receiv', 'int_receiv', 'inventories',
        'amor_exp', 'nca_within_1y', 'sett_rsrv', 'loanto_oth_bank', 'premium_receiv', 'reinsur_receiv',
        'reinsur_res_receiv', 'pur_resale_fa', 'oth_cur_assets', 'total_cur_assets', 'fa_avail_for_sale',
        'htm_invest	float', 'lt_eqt_invest', 'invest_real_estate', 'time_deposits', 'oth_assets	float',
        'lt_rec	float', 'fix_assets	float', 'cip', 'const_materials', 'fixed_assets_disp', 'produc_bio_assets',
        ...
        'loan_oth_bank', 'trading_fl	float', 'notes_payable', 'acct_payable', 'adv_receipts', 'sold_for_repur_fa',
